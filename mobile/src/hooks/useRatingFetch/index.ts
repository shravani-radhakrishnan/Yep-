...
// To switch: set EXPO_PUBLIC_GOOGLE_PLACES_API_KEY in .env, change activePlaceProvider below.
//
...
const FOURSQUARE_KEY = process.env.EXPO_PUBLIC_FOURSQUARE_API_KEY ?? '';
